 ...
 */
  ...
  /**
   * ESTA CLASE ES PARA ESTABLECER CONTROLES SWING CON EL MISMO FORMATO,
   * PARA AÑADIRLOS AL DESING SE USA __elementsDynamic().
   **/
...
public class __elementsInGUI {
    ...
    /**
     * ESTABLECE EL PROTOTIPO DE JTEXTFIELD Y SUS FUNCIONES COPY/PASTE CON EL RATON
     * @param text
     * @return nuevoCampo
     */
    ...
    /**
     * ESTABLECE EL PROTOTIPO DE JBUTTON Y SU FUNCION DE BORRAR EL TEXTO DE JTEXTFIELD 
     * @return botonDel
     */
