 ...
 */
   ...
   /** 
   * ESTA CLASE ES PARA CARGAR UN ARCHIVO DE MEMORIAS EN FORMATO JSON.
   **/
...
public class __loadElementsJson {
    ...
    */
    ...
    /**
     * ABRE FILECHOOSER PARA SELECCIONAR UN ARCHIVO
     */
    public void open() {
     ...
     /**
     * LEE EN FORMATO JSON Y MUESTRA EN DESING EL ARCHICO ABIERTO 
     * @param rutaArchivo
     */
